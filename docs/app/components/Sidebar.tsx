...
import { SidebarKey, toggle } from "@/app/store/slices/sidebarSlice";
...
export default function Sidebar() {
  ...
  const handleToggle = (event: any, id: SidebarKey) => {
  ...
  return (
    <ul className="menu text-lg rounded-box mt-16">
      <li>
        <details open={sidebarState["gettingStarted"]}>
          <summary
            onClick={(e) => handleToggle(e, "gettingStarted")}
            className="font-bold"
          >
            Getting Started
          </summary>
      ...
      <li>
        <details open={sidebarState["features"]}>
          <summary
            onClick={(e) => handleToggle(e, "features")}
            className="font-bold"
          >
            Features
          </summary>
          <ul>
            ...
            <li>
              <details open={sidebarState["routing"]}>
                <summary onClick={(e) => handleToggle(e, "routing")}>
                  Routing
                </summary>
                <ul>
                  <li>
